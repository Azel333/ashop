...
// 
        ...
        $this->form_validation->set_rules('email', 'Email', 'trim|required|valid_email|xss_clean|is_unique[email_info.email]',
            array(
...
if ($this->form_validation->run() == FALSE) {
	...
	public function login()
	{
        ...
        if ($email === '')
        {
            $this->session->set_flashdata('message','Email Kosong');
                            redirect('/');
        } else {
...
public function sub(){
    ...
    if ($this->form_validation->run() == FALSE) {
            ...
            $this->db->insert('email_info', $data);
            $this->session->set_flashdata('message','Subscription Berhasil!');
