...
public function __construct()
	{
		...
		$this->load->model('Hokunine_model', 'hokunine');
	...
	public function index()
	{
		...
		$data['provinsi']=$this->hokunine->provinsi();
	...
	function ambil_data(){
		...
		if($modul=="kabupaten"){
			echo $this->hokunine->kabupaten($id);
		}
		else if($modul=="kecamatan"){
			echo $this->hokunine->kecamatan($id);
		
		}
		else if($modul=="kelurahan"){
			echo $this->hokunine->kelurahan($id);
		}
	}
