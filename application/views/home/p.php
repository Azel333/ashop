                ...
                <div class="row pt-3 pb-3 rounded shadow-sm bg-white">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="product">
                            ...
                            <?php 
                            if ($user !== NULL) {
                                echo form_hidden('id_product', $p['id_products']);
                                echo form_hidden('id_user', $user['id_user']);
                                echo form_hidden('email_tmp', $user['email']);
                                echo form_hidden('total_price', $p['price_total']);
                                echo form_hidden('weight', $p['weight']);
                                echo form_hidden('stock', $p['stock']);
                            }
                            ?>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Catatan</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="note"
                                    placeholder="Contoh: Size M" rows="3" maxlength="100"></textarea>
                            </div>
