...
<head>
    ...
    <!-- Font awesome 5 -->
    <link href="<?= base_url('assets/')?>fonts/fontawesome/css/fontawesome-all.min.css" type="text/css"
        rel="stylesheet">
    <!-- plugin: fancybox  -->
    ...
    <!-- Sweetalert2 -->
    <script src="<?= base_url('include/sweetalert2')?>/sweetalert2.all.min.js" type="text/javascript"></script>
